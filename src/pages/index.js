    ...
    <Layout>
      ...
      <section className="hero custom-hero">
        <div className="hero-body">
          ...
          <div className="has-text-centered">
            <a href="https://drive.google.com/open?id=1QK1v7lkaeriJr9p16nFfU_UwGiD7hXuG" target="_blank" aria-label="curriculum vitae">
      ...
      <section className="container section content is-size-4-desktop is-size-5-touch">
        ...
        <p className="has-text-justified paragraph">
          I love studying Linux (Arch Linux), programming, reading, playing video games and traveling. Also, I can play the ocarina. I like the fact that I go to work every day by bycicle. Every month, I invest in stock market here in Brazil (buy and hold). Nowadays, I work as a <Link to="/stack/">web developer</Link> and as an English teacher. I study Computer Science at Unifacvest University Center.
        </p>
        <p className="has-text-justified paragraph">
